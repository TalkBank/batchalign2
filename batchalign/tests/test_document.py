...
TOKENIZED_DOC = {'content': [{'tier': {'lang': 'eng', 'corpus': 'corpus_name', 'id': 'PAR', 'name': 'Participant'}, 'content': [{'text': 'Good', 'time': None, 'morphology': None, 'dependency': None, 'type': 0}, {'text': 'morning', 'time': None, 'morphology': None, 'dependency': None, 'type': 0}, {'text': '!', 'time': None, 'morphology': None, 'dependency': None, 'type': 0}], 'text': None, 'delim': '.', 'time': None, 'custom_dependencies': [], 'alignment': None}, {'tier': {'lang': 'eng', 'corpus': 'corpus_name', 'id': 'PAR', 'name': 'Participant'}, 'content': [{'text': 'How', 'time': None, 'morphology': None, 'dependency': None, 'type':0}, {'text': 'are', 'time': None, 'morphology': None, 'dependency': None, 'type': 0}, {'text': 'ya', 'time': None, 'morphology': None, 'dependency': None, 'type': 0}, {'text': '?', 'time': None, 'morphology': None, 'dependency': None, 'type': 0}], 'text': None, 'delim': '.', 'time': None, 'custom_dependencies': [], 'alignment': None}], 'media': None, 'langs': ['eng'], 'tiers': [{'lang': 'eng', 'corpus': 'corpus_name', 'id': 'PAR', 'name': 'Participant'}]}
